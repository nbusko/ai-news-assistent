...
"""
Проверь, соответствует ли запрос пользователя какому-то событию / личности / происшествию / новости или предоставлению новостей.
Верни JSON в таком формате:
{{
"result": "..." // "no", если запрос не соответствует описанию выше, "yes" - если соответствует
}}
Запрос: {request}
